...
client.on('message', message => {
if(message.content.startsWith ("xmarry")) {
...
client.on('message', message => {
if (message.content.startsWith('xinvites')) {
...
client.on('message', async message => {
  if(message.content.startsWith(prefix + "mod")) {
    await message.channel.send("** ❓  عندك مايك جيد**").then(e => {
...
.then(co => {
  md = co.first().content
        co.first().delete()
        m.delete();
message.channel.send('**تقدر تساعد الاعضاء الموجودين فالسيرفر ❓ **').then(ms => {
...
const Sra7a = [
  ...
  client.on('message', message => {
if (message.content.startsWith('xصراحه')) {
    if(!message.channel.guild) return message.reply('** This command only for servers **');
...
client.on('message', message => {
  ...
  { message.member.setMute(false);
    ...
    if (msg.content.startsWith(`xwarn`)) {
...
client.on('message', async najzx => {
    if(najzx.content.startsWith("xtv")) {
...
client.on('message', message => {
 ...
 client.on('message', message => {
   if (message.content.startsWith("xكت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
╔[❖════════════❖]╗
             Admin Commands
╚[❖════════════❖]╝
 ❖ xclear ➾ clear chat (Dont Use Up OF 100)
 ❖ xmutevoice < mention > ➾ mutevoice member
 ❖ xunmutevoice <mention> ➾ unmutevoice member
 ❖ xtv ➾ create channel With Your Type
 ❖ xbc <message> ➾ message all members in server
╔[❖════════════❖]╗
            General  Commands
╚[❖════════════❖]╝ 
❖ xdate ➾ see date (متقدم ساعتين)
❖ xinvites ➾ server invite
❖ xping ➾ to see ping 
❖ xbot ➾ bot informations 
❖ xinvite ➾ bot invite link
❖ xاذكار ➾ azkar
╔[❖════════════❖]╗
                    Welcome
╚[❖════════════❖]╝
...
client.on('message' , message => {
 ...
 const adkar = [
  ...
  client.on('message', message => {
  if (message.author.bot) return;
  if (message.content.startsWith('xاذكار')) {
	if(!message.channel.guild) return;
  var client= new Discord.RichEmbed()
  .setTitle("**اذكار**")
  .setThumbnail(message.author.avatarURL)
...
client.on('message', message => {
    if (message.content.startsWith("xhack")) {
      if (message.author.bot) return
           message.delete();
             let args = message.content.split(' ').slice(1);
...
client.on("guildMemberAdd", member => {
        if(member.guild.id === "532667410671730700") { ////////////// Mal , Codes هنا ايدي السيرفر
  const channel = member.guild.channels.find('id', '532689462522675200'); ////////////// Mal , Codes هنا ايدي الروم اللي يحب فيه
if (!channel) return;
channel.send(`**<@${member.user.id}> Welcome To __XMAS Legends__  ** ❤️ `)  
}});
client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","LegendS"));
    });
...
client.on('message',function(message) {
   if(message.content.startsWith(prefix + "count")) {
       message.channel.send(`**عدد الاعضاء الموجودين بالسيرفر**: \`\`${client.users.size}\`\``);
   }
});
